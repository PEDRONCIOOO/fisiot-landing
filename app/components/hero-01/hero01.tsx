            ...
            <div className="container mx-auto px-4 z-10">
                ...
                >
                    ...
                    <motion.div className="lg:w-1/2" variants={itemVariants}>
                        <motion.span
                            className="inline-block text-black font-medium mb-2"
                        ...
                        <motion.h1
                            ...
                            variants={itemVariants}
                        >
                            Fisioterapia <span className="text-black">Concertando</span> para o mundo moderno.
                        </motion.h1>
                        <motion.p
                            className="text-slate-300 text-lg mb-8 max-w-lg"
                            variants={itemVariants}
                        >
                            Experimente soluções de fisioterapia de ponta que combinam atendimento especializado com tecnologia inovadora para entregar resultados superiores.
                        </motion.p>
